...
import com.example.mynavdata.ui.komponen.FormatLabelHarga
...
fun HalamanDua(
    ...
    val item = listOf(
        ...
        Pair(stringResource(R.string.telepon), orderUIState.tlp)
    )
    Column(
        modifier = modifier,
        ...
        Row(
            ...
            Column(
                ...
                OutlinedButton(
                    modifier = Modifier.fillMaxWidth(), onClick = onCancelButtonClicked
                ) {
